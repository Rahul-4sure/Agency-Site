...
const ServiceCard = ({service,index}) => {
  ...
  return (
    <div className='relative max-w-lg overflow-hidden m-2 sm:m-4  rounded-xl border border-gray-200 dark:border-gray-700  shadow-2xl shadow-gray-100 dark:shadow-white/10 ' onMouseEnter={()=>setvisible(true)} onMouseLeave={()=>setvisible(false)} ref={divRef} onMouseMove={handleMouseMove}>
