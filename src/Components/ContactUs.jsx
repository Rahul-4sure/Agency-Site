...
const ContactUs = () => {
    ...
    formData.append("access_key", "65596de6-1c8b-4d17-9f11-6673336c8f99");
  ...
  return (
    <div id='contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
        ...
        <form className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full' onSubmit={onSubmit} >
            ...
            <button type='submit' className='w-max flex gap-2 bg-primary text-white test-sm  px-10 py-3 rounded-full cursor-pointer hover:scale-103 transition-all '>Submit 
